...
-----------------------------------------------------
{
  ...
  "heart_rate":     { "avg_bpm_serial": 72.4, "n_serial_samples": 5,
...
class DataExporter:
    ...
    def build_payload(
        ...
        *,
        ...
        # Heart rate (serial stream averaged over the window)
        ...
        # Accelerometer HAR feature dict
        ...
        payload = {
            ...
            "heart_rate": {
                "avg_bpm_serial":  _r(avg_hr_bpm, 1),
                "n_serial_samples": n_hr_samples,
